import { getToken } from '../../../../services/platforms/instagram.js';
...
async function handler(req, res) {
  try {
    ...
    const { access_token, user_id: igUserId, expires_in } = tokenData;
    ...
    await logAudit(user_id, 'instagram', 'connected');
