...
const sidebarMenuButtonVariants = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$class$2d$variance$2d$authority$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cva"])("peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-lg p-2 text-left text-sm outline-hidden ring-sidebar-ring transition-all duration-300 hover:bg-gradient-to-r hover:from-pink-500/20 hover:to-purple-600/20 hover:text-white focus-visible:ring-2 focus-visible:ring-pink-500/50 active:bg-gradient-to-r active:from-pink-500/30 active:to-purple-600/30 active:text-white disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0", {
    variants: {
        variant: {
            default: "hover:bg-gradient-to-r hover:from-pink-500/20 hover:to-purple-600/20 hover:text-white",
            outline: "bg-white/5 backdrop-blur-sm border border-white/10 shadow-lg shadow-black/10 hover:bg-gradient-to-r hover:from-pink-500/20 hover:to-purple-600/20 hover:text-white hover:shadow-xl hover:shadow-black/20"
        },
        size: {
...
//# sourceMappingURL=src_components_ui_ed288b0a._.js.map